...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_shared_nav_nav_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
        ...
        value: function ngOnInit() {
          ...
          this.router.events.subscribe(function (data) {
            if (data instanceof _angular_router__WEBPACK_IMPORTED_MODULE_1__["RoutesRecognized"]) {
              _this.info = data.state.root.firstChild.data; //alert(JSON.stringify(this.info.login));

              if (_this.info.login == "login") {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgIf"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterOutlet"], _components_shared_nav_nav_component__WEBPACK_IMPORTED_MODULE_3__["NavComponent"], _components_shared_footer_footer_component__WEBPACK_IMPORTED_MODULE_4__["FooterComponent"]],
  ...
  /***/
  function srcAppComponentsCartCartItemCartItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*! @angular/common */
    "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js"); //import {CartUser} from "../../../models/product";
    ...
    var CartItemComponent = /*#__PURE__*/function () {
      ...
      _createClass(CartItemComponent, [{
        ...
        key: "getCartItemUser",
        value: function getCartItemUser(users) {
          var cartUser;
  ...
  function srcAppComponentsCartCartComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CartComponent = /*#__PURE__*/function () {
      function CartComponent(cartService, productService, loginService, router) {
      ...
      _createClass(CartComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.loggedInUser = JSON.parse(sessionStorage.getItem("loggedInUser"));
          this.subscription = this.cartService.getMsg().subscribe(function (product) {
            alert("123");

            _this2.addToCartItems(product);
          });
        }
      }, {
        key: "ngOnDestroy",
        ...
        key: "addToCartItems",
        value: function addToCartItems(product) {
          var _this3 = this;

          alert(JSON.stringify(product));
          this.cartService.getCartUser(product, this.loggedInUser).then(function (user) {
            _this3.cart = user; //alert(this.cart);

            if (_this3.cart == null || !_this3.cart.userId) //User Not existed
              {
                //insert user
                _this3.cartService.addUserAndProductToCart(product, _this3.loggedInUser).then();
              } else {
              //increase user product quantity in cart
              _this3.ModifyCartQuantity(product);

              _this3.cartService.incrementProductQuantityInCart(product, _this3.cart).then(function (res) {});
            }
          });
        ...
        value: function getAllCartItems() {
          ...
          this.cartService.getAllCartItems(this.loggedInUser).then(function (res) {
            _this4.cart = res;
            _this4.cartItems = _this4.cart.productList;
          });
        }
      }, {
        key: "ModifyCartQuantity",
        value: function ModifyCartQuantity(product) {
          var productIdExists = false;

          var _iterator2 = _createForOfIteratorHelper(this.cart.productList),
              _step2;
        ...
        key: "showItemsInCart",
        value: function showItemsInCart(product) {
          var foundIndex = this.cartItems.findIndex(function (item) {
            return item.id == product.id;
          });
          if (foundIndex != -1) this.cartItems[foundIndex] = product;else this.cartItems.push(product);
        }
      }, {
        key: "addUsersToProduct",
        value: function addUsersToProduct(product) {
          var _this5 = this;

          var userExists = false;
          product.users.forEach(function (user) {
            if (user.userId == _this5.loggedInUser.userId) {
              userExists = true;
              user.qty++;
            }
          });
    ...
    CartComponent.ɵfac = function CartComponent_Factory(t) {
      return new (t || CartComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_cart_service__WEBPACK_IMPORTED_MODULE_1__["CartService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_product_service__WEBPACK_IMPORTED_MODULE_2__["ProductService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_login_service__WEBPACK_IMPORTED_MODULE_3__["LoginService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]));
    };
  ...
  /***/
  function srcAppComponentsCategoriesElectronicsElectronicsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    ElectronicsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 4,
      vars: 1,
      consts: [[1, "row"], [1, "col-2"], [1, "col-8"], [3, "category"]],
  ...
  /***/
  function srcAppComponentsCategoriesFurnitureFurnitureComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsCategoriesKidsKidsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var KidsComponent = /*#__PURE__*/function () {
  ...
  /***/
  function srcAppComponentsCategoriesMenMenComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsCategoriesWomenWomenComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppComponentsLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function LoginComponent_mat_error_45_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-error");
    ...
    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(router, loginService, productService) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function login(username, password) {
          ...
          this.loginService.getUser(this.username).then(function (user) {
            _this6.user = user;

            if (user == undefined) {
              _this6.setInvalidErrorMessage("User not existed.Please sign up");
            }

            if (_this6.username == _this6.user.userId && _this6.password == _this6.user.password) {
              sessionStorage.setItem("loggedInUser", JSON.stringify(_this6.user));
              validUser = true;

              _this6.router.navigate(["/home"]);
            }

            _this6.setInvalidErrorMessage(validUser ? "" : "Invalid Credentials");
          });
        }
      }, {
        key: "setInvalidErrorMessage",
        value: function setInvalidErrorMessage(message) {
        ...
        value: function signUp(username, password) {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
            var userExisted, user, existedUser, newUser;
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    this.password = password;
                    userExisted = false;
                    user = new _models_user__WEBPACK_IMPORTED_MODULE_2__["User"](this.username, this.password);
                    _context.next = 6;
                    return this.loginService.getUser(this.username);

                  case 6:
                    existedUser = _context.sent;

                    if (existedUser == undefined) {
                      newUser = this.loginService.addUser(user);
                    } else {
                      userExisted = true;
                    }
        ...
        key: "signUpMessage",
        value: function signUpMessage(msg) {
      ...
      template: function LoginComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function LoginComponent_Template_button_click_24_listener() {
            ...
            return ctx.login(_r2.value, _r4.value);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function LoginComponent_Template_button_click_50_listener() {
            ...
            var _r8 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](31);

            var _r10 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](37);

            return ctx.signUp(_r8.value, _r10.value);
          });
        ...
        if (rf & 2) {
          ...
          var _r13 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](44);
  ...
  function srcAppComponentsOrderOrderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    OrderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 0,
      consts: [[1, "order"], ["routerLink", "../home"]],
  ...
  /***/
  function srcAppComponentsOrderedListOrderedItemOrderedItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OrderedItemComponent", function () {
    ...
    var OrderedItemComponent = /*#__PURE__*/function () {
      function OrderedItemComponent() {
        _classCallCheck(this, OrderedItemComponent);
      }

      _createClass(OrderedItemComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    OrderedItemComponent.ɵfac = function OrderedItemComponent_Factory(t) {
      return new (t || OrderedItemComponent)();
    };

    OrderedItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: OrderedItemComponent,
      selectors: [["app-ordered-item"]],
      inputs: {
        orderedItem: ["showOrderedItem", "orderedItem"]
      },
      decls: 15,
      vars: 9,
      consts: [[1, "container"], [1, "row"], [1, "col-sm"], ["width", "50%", 1, "bd-placeholder-img", "card-img-top", "p-2", 3, "src"], [1, "card-text-sm"], [1, "text-muted"]],
      template: function OrderedItemComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](OrderedItemComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsOrderedListOrderedListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _ordered_item_ordered_item_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./ordered-item/ordered-item.component */
    "./src/app/components/ordered-list/ordered-item/ordered-item.component.ts");

    function OrderedListComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function OrderedListComponent_ul_1_li_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function OrderedListComponent_ul_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var OrderedListComponent = /*#__PURE__*/function () {
      function OrderedListComponent(cartService, productService) {
      ...
      _createClass(OrderedListComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.loggedInUser = JSON.parse(sessionStorage.getItem("loggedInUser")); //load Cart Items on UI
        ...
        value: function getAllItems() {
          ...
          this.cartService.getAllCartItems(this.loggedInUser).then(function (res) {
            ...
            _this7.cart = res;
            _this7.orderItems = res.orderedProductsList;

            _this7.getProductsInCart(_this7.cart);
          });
        }
      }, {
        key: "getProductsInCart",
        value: function getProductsInCart(userCartItem) {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
            var _iterator3, _step3, cartItem, productId, data;

            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    _iterator3 = _createForOfIteratorHelper(this.orderItems);
                    _context2.prev = 1;
        ...
        value: function calculateTotal() {
          ...
          this.cartTotal = 0;
          this.orderedProducts.forEach(function (item) {
            // this.cartUser = this.getCartUser(item.users);
            _this8.cartTotal += parseInt(item.quantity) * parseInt(item.data.price);
          });
        }
      }]);
    ...
    OrderedListComponent.ɵfac = function OrderedListComponent_Factory(t) {
      return new (t || OrderedListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_cart_service__WEBPACK_IMPORTED_MODULE_2__["CartService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_product_service__WEBPACK_IMPORTED_MODULE_3__["ProductService"]));
    };

    OrderedListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      type: OrderedListComponent,
      selectors: [["app-ordered-list"]],
      decls: 2,
      vars: 2,
      consts: [["class", "alert alert-info", 4, "ngIf"], ["class", "list-group", 4, "ngIf"], [1, "alert", "alert-info"], [1, "list-group"], [1, "row"], ["class", "list-group-item", 4, "ngFor", "ngForOf"], [1, "col"], [1, "list-group-item", "active", "total"], [1, "list-group-item"], [3, "showOrderedItem"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgForOf"], _ordered_item_ordered_item_component__WEBPACK_IMPORTED_MODULE_5__["OrderedItemComponent"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](OrderedListComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsProductListProductDetailProductDetailComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ProductDetailComponent = /*#__PURE__*/function () {
      function ProductDetailComponent(activatedRoute, productService, cartService, router) {
      ...
      _createClass(ProductDetailComponent, [{
            ...
            return regeneratorRuntime.wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    _context4.next = 2;
                    return this.cartService.getCartUser(product, this.loggedInUser);

                  case 2:
                    user = _context4.sent;
                    this.cart = user;

                    if (!(this.cart == null || !this.cart.userId)) {
                      _context4.next = 10;
                      break;
                    }

                    _context4.next = 7;
                    return this.cartService.addUserAndProductToCart(product, this.loggedInUser);
                  ...
                  case 10:
                    ...
                    this.ModifyCartQuantity(product);
                    _context4.next = 13;
                    return this.cartService.incrementProductQuantityInCart(product, this.cart);
        ...
        value: function getAllCartItems() {
          ...
          this.cartService.getAllCartItems(this.loggedInUser).then(function (res) {
            _this9.cart = res;
            _this9.cartItems = _this9.cart.productList;
          });
        }
      }, {
        key: "ModifyCartQuantity",
        value: function ModifyCartQuantity(product) {
          ...
          var _iterator4 = _createForOfIteratorHelper(this.cart.productList),
              _step4;
        ...
        value: function addUsersToProduct(product) {
          ...
          var userExists = false;
          product.users.forEach(function (user) {
            if (user.userId == _this10.loggedInUser.userId) {
              userExists = true;
              user.qty++;
            }
          });
    ...
    ProductDetailComponent.ɵfac = function ProductDetailComponent_Factory(t) {
      return new (t || ProductDetailComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_product_service__WEBPACK_IMPORTED_MODULE_4__["ProductService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_cart_service__WEBPACK_IMPORTED_MODULE_5__["CartService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]));
    };
    ...
    ProductDetailComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      decls: 16,
      vars: 6,
      consts: [[1, "row", "detailRow"], [1, "col"], [1, "row"], ["mat-card-image", "", 3, "src"], [1, "row", "btnRow"], [1, "btn", "btn-primary", 3, "click"], [1, "text-muted"], [1, "card-text"]],
      template: function ProductDetailComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ProductDetailComponent_Template_button_click_5_listener() {
            return ctx.handleAddToCart(ctx.product);
          });
      ...
      directives: [_angular_material_card__WEBPACK_IMPORTED_MODULE_6__["MatCardImage"]],
  ...
  /***/
  function srcAppComponentsProductListProductItemProductItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ProductItemComponent = /*#__PURE__*/function () {
      function ProductItemComponent(cartService, router) {
      ...
      _createClass(ProductItemComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {} //this.cartService.sharedMessage.subscribe(message => this.message = message)
        ...
        value: function showProductDetail(productItem) {
    ...
    ProductItemComponent.ɵfac = function ProductItemComponent_Factory(t) {
      return new (t || ProductItemComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_cart_service__WEBPACK_IMPORTED_MODULE_1__["CartService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]));
    };
    ...
    ProductItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 13,
      vars: 6,
      consts: [[3, "click"], [1, "example-card"], ["mat-card-image", "", 3, "src"], [1, "text-muted"], [1, "card-text"]],
      template: function ProductItemComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "a", 0);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductItemComponent_Template_a_click_0_listener() {
            return ctx.showProductDetail(ctx.productItem);
          });
      ...
      directives: [_angular_material_card__WEBPACK_IMPORTED_MODULE_3__["MatCard"], _angular_material_card__WEBPACK_IMPORTED_MODULE_3__["MatCardImage"], _angular_material_card__WEBPACK_IMPORTED_MODULE_3__["MatCardContent"], _angular_material_card__WEBPACK_IMPORTED_MODULE_3__["MatCardActions"]],
      pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CurrencyPipe"]],
    ...
    var ProductListComponent = /*#__PURE__*/function () {
      ...
      _createClass(ProductListComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.productService.getProductsOnCategory(this.category ? this.category : "").then(function (res) {
            _this11.products = res;
          });
        }
      }]);
  ...
  function srcAppComponentsSharedFooterFooterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    FooterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 0,
      consts: [[1, "pt-4", "my-md-5", "pt-md-5", "border-top"], [1, "footer-copyright", "text-center", "py-3"], ["href", ""]],
  ...
  function srcAppComponentsSharedNavNavComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var NavComponent = /*#__PURE__*/function () {
      ...
      _createClass(NavComponent, [{
        ...
        key: "showCartItems",
        value: function showCartItems() {
          this.router.navigate(['../cart']);
        }
      }, {
        key: "showOrderedItems",
        value: function showOrderedItems() {
    ...
    NavComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 44,
      vars: 7,
      consts: [["color", "primary"], ["mat-button", "", 3, "routerLink"], [1, "col-8"], [1, "input-group"], ["type", "text", "placeholder", "Search this site", 1, "form-control"], [1, "input-group-append"], ["type", "button", 1, "btn", "btn-secondary", "search-Button"], [1, "fa", "fa-search", "form-control-feedback"], [1, "col", "account"], ["mat-icon-button", "", 3, "matMenuTriggerFor"], ["auth", "matMenu"], ["mat-menu-item", "", 3, "click"], [1, "menu-spacer"], [1, "nav-links"]],
      template: function NavComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NavComponent_Template_button_click_21_listener() {
            return ctx.showOrderedItems();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NavComponent_Template_button_click_26_listener() {
        ...
        if (rf & 2) {
          var _r36 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](15);
  ...
  /***/
  function srcAppComponentsShowCartCheckoutCheckoutComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var CheckoutComponent = /*#__PURE__*/function () {
      function CheckoutComponent(productService, router, cartService) {
      ...
      _createClass(CheckoutComponent, [{
        ...
        key: "addToOrderedItems",
        value: function addToOrderedItems(product) {
              ...
              while (1) {
                switch (_context6.prev = _context6.next) {
                  ...
                  case 2:
                    ...
                    this.cart.productList = []; // alert(JSON.stringify(this.cart));

                    _context6.next = 8;
                    return this.cartService.updateOrderedItems(this.cart, this.loggedInUser);
    ...
    CheckoutComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      template: function CheckoutComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function CheckoutComponent_Template_button_click_140_listener() {
            return ctx.checkOutDone();
          });
  ...
  /***/
  function srcAppComponentsShowCartShowCartItemShowCartItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ShowCartItemComponent", function () {
      return ShowCartItemComponent;
    });
    /* harmony import */
    ...
    var ShowCartItemComponent = /*#__PURE__*/function () {
      function ShowCartItemComponent() {
        _classCallCheck(this, ShowCartItemComponent);

        this.outputToParent = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
      }

      _createClass(ShowCartItemComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "decrementProductQuantity",
        value: function decrementProductQuantity() {
        ...
        value: function incrementProductQuantity() {
    ...
    ShowCartItemComponent.ɵfac = function ShowCartItemComponent_Factory(t) {
      return new (t || ShowCartItemComponent)();
    };

    ShowCartItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ShowCartItemComponent,
      selectors: [["app-show-cart-item"]],
      inputs: {
        cartItem: ["showcartItem", "cartItem"]
      },
      outputs: {
        outputToParent: "outputToParent"
      },
      decls: 25,
      vars: 10,
      consts: [[1, "container"], [1, "row"], [1, "col-sm"], ["width", "50%", 1, "bd-placeholder-img", "card-img-top", "p-2", 3, "src"], [1, "card-text-sm"], [1, "text-muted"], [1, "number"], [1, "minus", 3, "click"], ["type", "text", 3, "value"], [1, "plus", 3, "click"], [1, "remove"], [1, "btn", "btn-primary", 3, "click"]],
      template: function ShowCartItemComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ShowCartItemComponent_Template_span_click_17_listener() {
            return ctx.decrementProductQuantity();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ShowCartItemComponent_Template_span_click_20_listener() {
            return ctx.incrementProductQuantity();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ShowCartItemComponent_Template_button_click_23_listener() {
            return ctx.removeCartItem(ctx.cartItem);
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ShowCartItemComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsShowCartShowCartComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ShowCartComponent", function () {
    ...
    var _show_cart_item_show_cart_item_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./show-cart-item/show-cart-item.component */
    "./src/app/components/show-cart/show-cart-item/show-cart-item.component.ts");

    function ShowCartComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 2);
    ...
    function ShowCartComponent_ul_1_li_2_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("outputToParent", function ShowCartComponent_ul_1_li_2_Template_app_show_cart_item_outputToParent_1_listener($event) {
          ...
          return ctx_r28.cartAction($event);
        });
    ...
    function ShowCartComponent_ul_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ShowCartComponent_ul_1_Template_button_click_6_listener() {
          ...
          return ctx_r30.placeOrder(ctx_r30.cartProducts);
        });
    ...
    var ShowCartComponent = /*#__PURE__*/function () {
      function ShowCartComponent(cartService, productService, router) {
        _classCallCheck(this, ShowCartComponent);
      ...
      _createClass(ShowCartComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.loggedInUser = JSON.parse(sessionStorage.getItem("loggedInUser")); //load Cart Items on UI
        ...
        value: function getAllItems() {
          ...
          this.cartService.getAllCartItems(this.loggedInUser).then(function (res) {
            _this12.cart = res;
            _this12.cartItems = res.productList;

            _this12.getProductsInCart(_this12.cart);
          });
        }
      }, {
        key: "getProductsInCart",
        value: function getProductsInCart(userCartItem) {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
            var _iterator5, _step5, cartItem, productId, data;

            return regeneratorRuntime.wrap(function _callee7$(_context7) {
              while (1) {
                switch (_context7.prev = _context7.next) {
                  case 0:
                    _iterator5 = _createForOfIteratorHelper(this.cartItems);
                    _context7.prev = 1;
        ...
        value: function calculateTotal() {
          ...
          this.cartProducts.forEach(function (item) {
            // this.cartUser = this.getCartUser(item.users);
            _this13.cartTotal += parseInt(item.quantity) * parseInt(item.data.price);
          });
        }
      }, {
        key: "cartAction",
        value: function cartAction(event) {
          var _this14 = this;

          if (event.action == "decrement") {
            // event.quantity --;
            this.ModifyCartQuantity(event, true); // alert(JSON.stringify(event));

            this.cartService.incrementOrDecrementQuantity(event, this.loggedInUser).then(function (res) {
              _this14.getAllItems();
            });
        ...
        key: "removeCartItem",
        value: function removeCartItem(ProductWithCartItem) {
          var productId = ProductWithCartItem.data._id;
          var productIdExists = false;

          for (var i = 0; i < ProductWithCartItem.cartItem.productList.length; i++) {
            var cp = ProductWithCartItem.cartItem.productList[i];
        ...
        key: "ModifyCartQuantity",
        value: function ModifyCartQuantity(ProductWithCartItem, decrement) {
          var productId = ProductWithCartItem.data._id;
          var productIdExists = false;
          ...
          for (var i = 0; i < ProductWithCartItem.cartItem.productList.length; i++) {
            ...
            if (cp.productId == productId) {
              if (decrement) cp.quantity = (parseInt(cp.quantity) - 1).toString();else cp.quantity = (parseInt(cp.quantity) + 1).toString();
        ...
        */
        ...
        key: "placeOrder",
        value: function placeOrder(cartProducts) {
    ...
    ShowCartComponent.ɵfac = function ShowCartComponent_Factory(t) {
      return new (t || ShowCartComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_cart_service__WEBPACK_IMPORTED_MODULE_2__["CartService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_product_service__WEBPACK_IMPORTED_MODULE_3__["ProductService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]));
    };

    ShowCartComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      type: ShowCartComponent,
      selectors: [["app-show-cart"]],
      decls: 2,
      vars: 2,
      consts: [["class", "alert alert-info", 4, "ngIf"], ["class", "list-group", 4, "ngIf"], [1, "alert", "alert-info"], [1, "list-group"], [1, "row"], ["class", "list-group-item", 4, "ngFor", "ngForOf"], [1, "col-6"], [1, "list-group-item", "active", "total", "order"], ["mat-button", "", 3, "click"], [1, "col"], [1, "list-group-item", "active", "total"], [1, "list-group-item"], [3, "showcartItem", "outputToParent"]],
      template: function ShowCartComponent_Template(rf, ctx) {
        if (rf & 1) {
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgForOf"], _angular_material_button__WEBPACK_IMPORTED_MODULE_6__["MatButton"], _show_cart_item_show_cart_item_component__WEBPACK_IMPORTED_MODULE_7__["ShowCartItemComponent"]],
      pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["CurrencyPipe"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](ShowCartComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"],
        args: [{
  ...
  function srcAppComponentsUserUserComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    UserComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 64,
      vars: 0,
      consts: [[1, "container"], [1, "card-deck", "mb-3", "text-center"], [1, "card", "mb-4", "box-shadow"], [1, "card-header"], [1, "my-0", "font-weight-normal"], [1, "card-body"], [1, "card-title", "pricing-card-title"], [1, "text-muted"], [1, "list-unstyled", "mt-3", "mb-4"], ["type", "button", 1, "btn", "btn-lg", "btn-block", "btn-outline-primary"], ["type", "button", 1, "btn", "btn-lg", "btn-block", "btn-primary"]],
      ...
      directives: [_shared_nav_nav_component__WEBPACK_IMPORTED_MODULE_1__["NavComponent"], _shared_footer_footer_component__WEBPACK_IMPORTED_MODULE_2__["FooterComponent"]],
  ...
  function srcAppModelsProductTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var Product = //users:[CartUser];
    function Product(id, name, description, price, imageUrl, category) {
      ...
      this.category = category; //this.users.push(cartUser);
    };
    /***/
  ...
  function srcAppModulesAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_categories_men_men_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../components/categories/men/men.component */
    "./src/app/components/categories/men/men.component.ts");
    /* harmony import */


    var _components_categories_women_women_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../components/categories/women/women.component */
    "./src/app/components/categories/women/women.component.ts");
    /* harmony import */


    var _components_categories_kids_kids_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../components/categories/kids/kids.component */
    "./src/app/components/categories/kids/kids.component.ts");
    /* harmony import */
    ...
    var _components_show_cart_show_cart_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../components/show-cart/show-cart.component */
    "./src/app/components/show-cart/show-cart.component.ts");
    /* harmony import */


    var _components_product_list_product_detail_product_detail_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ../components/product-list/product-detail/product-detail.component */
    "./src/app/components/product-list/product-detail/product-detail.component.ts");
    /* harmony import */


    var _components_show_cart_checkout_checkout_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ../components/show-cart/checkout/checkout.component */
    "./src/app/components/show-cart/checkout/checkout.component.ts");
    /* harmony import */
    ...
    var _components_categories_furniture_furniture_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ../components/categories/furniture/furniture.component */
    "./src/app/components/categories/furniture/furniture.component.ts");
    /* harmony import */


    var _components_categories_electronics_electronics_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ../components/categories/electronics/electronics.component */
    "./src/app/components/categories/electronics/electronics.component.ts");
    /* harmony import */


    var _components_ordered_list_ordered_list_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ../components/ordered-list/ordered-list.component */
    "./src/app/components/ordered-list/ordered-list.component.ts");
    /* harmony import */


    var _services_auth_guard__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ../services/auth.guard */
    ...
    var routes = [{
      ...
      path: 'men',
      component: _components_categories_men_men_component__WEBPACK_IMPORTED_MODULE_5__["MenComponent"],
      canActivate: [_services_auth_guard__WEBPACK_IMPORTED_MODULE_16__["AuthGuard"]]
    }, {
      path: 'women',
      component: _components_categories_women_women_component__WEBPACK_IMPORTED_MODULE_6__["WomenComponent"],
      canActivate: [_services_auth_guard__WEBPACK_IMPORTED_MODULE_16__["AuthGuard"]]
    }, {
      path: 'kids',
      component: _components_categories_kids_kids_component__WEBPACK_IMPORTED_MODULE_7__["KidsComponent"],
      canActivate: [_services_auth_guard__WEBPACK_IMPORTED_MODULE_16__["AuthGuard"]]
    }, {
      path: 'furniture',
      component: _components_categories_furniture_furniture_component__WEBPACK_IMPORTED_MODULE_13__["FurnitureComponent"],
      canActivate: [_services_auth_guard__WEBPACK_IMPORTED_MODULE_16__["AuthGuard"]]
    }, {
      path: 'electronics',
      component: _components_categories_electronics_electronics_component__WEBPACK_IMPORTED_MODULE_14__["ElectronicsComponent"],
      canActivate: [_services_auth_guard__WEBPACK_IMPORTED_MODULE_16__["AuthGuard"]]
    }, {
      path: 'home',
      ...
      path: 'cart',
      component: _components_show_cart_show_cart_component__WEBPACK_IMPORTED_MODULE_9__["ShowCartComponent"],
      canActivate: [_services_auth_guard__WEBPACK_IMPORTED_MODULE_16__["AuthGuard"]]
    }, {
      path: 'orderItems',
      component: _components_ordered_list_ordered_list_component__WEBPACK_IMPORTED_MODULE_15__["OrderedListComponent"],
      canActivate: [_services_auth_guard__WEBPACK_IMPORTED_MODULE_16__["AuthGuard"]]
    }, {
      path: 'productDetail/:productId',
      component: _components_product_list_product_detail_product_detail_component__WEBPACK_IMPORTED_MODULE_10__["ProductDetailComponent"],
      canActivate: [_services_auth_guard__WEBPACK_IMPORTED_MODULE_16__["AuthGuard"]]
    }, {
      path: 'checkout',
      component: _components_show_cart_checkout_checkout_component__WEBPACK_IMPORTED_MODULE_11__["CheckoutComponent"],
      canActivate: [_services_auth_guard__WEBPACK_IMPORTED_MODULE_16__["AuthGuard"]]
    }, {
      path: 'order',
      component: _components_order_order_component__WEBPACK_IMPORTED_MODULE_12__["OrderComponent"],
      canActivate: [_services_auth_guard__WEBPACK_IMPORTED_MODULE_16__["AuthGuard"]]
    }, {
      path: '**',
  ...
  /***/
  function srcAppModulesAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _AppRoutingModule__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./AppRoutingModule */
    "./src/app/modules/AppRoutingModule.ts");
    /* harmony import */
    ...
    var _components_product_list_product_list_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ../components/product-list/product-list.component */
    "./src/app/components/product-list/product-list.component.ts");
    /* harmony import */


    var _components_product_list_product_item_product_item_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ../components/product-list/product-item/product-item.component */
    "./src/app/components/product-list/product-item/product-item.component.ts");
    /* harmony import */
    ...
    var _components_cart_cart_item_cart_item_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ../components/cart/cart-item/cart-item.component */
    "./src/app/components/cart/cart-item/cart-item.component.ts");
    /* harmony import */
    ...
    var _components_categories_women_women_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ../components/categories/women/women.component */
    "./src/app/components/categories/women/women.component.ts");
    /* harmony import */


    var _components_categories_men_men_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ../components/categories/men/men.component */
    "./src/app/components/categories/men/men.component.ts");
    /* harmony import */


    var _components_categories_kids_kids_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! ../components/categories/kids/kids.component */
    "./src/app/components/categories/kids/kids.component.ts");
    /* harmony import */


    var _components_show_cart_show_cart_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! ../components/show-cart/show-cart.component */
    "./src/app/components/show-cart/show-cart.component.ts");
    /* harmony import */


    var _components_show_cart_show_cart_item_show_cart_item_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
    /*! ../components/show-cart/show-cart-item/show-cart-item.component */
    "./src/app/components/show-cart/show-cart-item/show-cart-item.component.ts");
    /* harmony import */
    ...
    var _components_product_list_product_detail_product_detail_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
    /*! ../components/product-list/product-detail/product-detail.component */
    "./src/app/components/product-list/product-detail/product-detail.component.ts");
    /* harmony import */


    var _components_show_cart_checkout_checkout_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(
    /*! ../components/show-cart/checkout/checkout.component */
    "./src/app/components/show-cart/checkout/checkout.component.ts");
    /* harmony import */


    var _components_order_order_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(
    /*! ../components/order/order.component */
    "./src/app/components/order/order.component.ts");
    /* harmony import */


    var _components_categories_electronics_electronics_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(
    /*! ../components/categories/electronics/electronics.component */
    "./src/app/components/categories/electronics/electronics.component.ts");
    /* harmony import */


    var _components_categories_furniture_furniture_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(
    /*! ../components/categories/furniture/furniture.component */
    "./src/app/components/categories/furniture/furniture.component.ts");
    /* harmony import */


    var _components_ordered_list_ordered_item_ordered_item_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(
    /*! ../components/ordered-list/ordered-item/ordered-item.component */
    "./src/app/components/ordered-list/ordered-item/ordered-item.component.ts");
    /* harmony import */


    var _components_ordered_list_ordered_list_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(
    /*! ../components/ordered-list/ordered-list.component */
    "./src/app/components/ordered-list/ordered-list.component.ts");
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_5__["BrowserAnimationsModule"], _material_module__WEBPACK_IMPORTED_MODULE_6__["CustomMaterialModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _AppRoutingModule__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_16__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"], _angular_material_tabs__WEBPACK_IMPORTED_MODULE_22__["MatTabsModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_23__["MatCheckboxModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_24__["MatSidenavModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_25__["MatListModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _components_login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"], _components_user_user_component__WEBPACK_IMPORTED_MODULE_4__["UserComponent"], _components_shared_nav_nav_component__WEBPACK_IMPORTED_MODULE_9__["NavComponent"], _components_shared_footer_footer_component__WEBPACK_IMPORTED_MODULE_10__["FooterComponent"], _components_product_list_product_list_component__WEBPACK_IMPORTED_MODULE_11__["ProductListComponent"], _components_product_list_product_item_product_item_component__WEBPACK_IMPORTED_MODULE_12__["ProductItemComponent"], _components_home_home_component__WEBPACK_IMPORTED_MODULE_13__["HomeComponent"], _components_cart_cart_component__WEBPACK_IMPORTED_MODULE_15__["CartComponent"], _components_cart_cart_item_cart_item_component__WEBPACK_IMPORTED_MODULE_14__["CartItemComponent"], _components_categories_men_men_component__WEBPACK_IMPORTED_MODULE_18__["MenComponent"], _components_categories_women_women_component__WEBPACK_IMPORTED_MODULE_17__["WomenComponent"], _components_categories_kids_kids_component__WEBPACK_IMPORTED_MODULE_19__["KidsComponent"], _components_show_cart_show_cart_component__WEBPACK_IMPORTED_MODULE_20__["ShowCartComponent"], _components_show_cart_show_cart_item_show_cart_item_component__WEBPACK_IMPORTED_MODULE_21__["ShowCartItemComponent"], _components_product_list_product_detail_product_detail_component__WEBPACK_IMPORTED_MODULE_26__["ProductDetailComponent"], _components_show_cart_checkout_checkout_component__WEBPACK_IMPORTED_MODULE_27__["CheckoutComponent"], _components_order_order_component__WEBPACK_IMPORTED_MODULE_28__["OrderComponent"], _components_categories_furniture_furniture_component__WEBPACK_IMPORTED_MODULE_30__["FurnitureComponent"], _components_categories_electronics_electronics_component__WEBPACK_IMPORTED_MODULE_29__["ElectronicsComponent"], _components_ordered_list_ordered_list_component__WEBPACK_IMPORTED_MODULE_32__["OrderedListComponent"], _components_ordered_list_ordered_item_ordered_item_component__WEBPACK_IMPORTED_MODULE_31__["OrderedItemComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_5__["BrowserAnimationsModule"], _material_module__WEBPACK_IMPORTED_MODULE_6__["CustomMaterialModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _AppRoutingModule__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_16__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"], _angular_material_tabs__WEBPACK_IMPORTED_MODULE_22__["MatTabsModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_23__["MatCheckboxModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_24__["MatSidenavModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_25__["MatListModule"]]
      });
    })();
    /*@__PURE__*/
    ...
    var AuthGuard = /*#__PURE__*/function () {
      ...
      _createClass(AuthGuard, [{
        ...
        value: function canActivate(route, state) {
          var sessionUser = sessionStorage.getItem("loggedInUser");
  ...
  function srcAppServicesCartServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CartService = /*#__PURE__*/function () {
      ...
      _createClass(CartService, [{
        ...
        key: "getCartUser",
        value: function getCartUser(product, loggedInUser) {
          return this.http.get(this.cartsUrl + "/" + loggedInUser.userId).toPromise().then(function (res) {
            return res;
          })["catch"](this.handleError);
        }
      }, {
        key: "addUserAndProductToCart",
        value: function addUserAndProductToCart(product, loggedInUser) {
          return this.http.post(this.cartsUrl + "/" + loggedInUser.userId, product).toPromise().then(function (res) {
            return res;
          })["catch"](this.handleError);
        }
      }, {
        key: "incrementProductQuantityInCart",
        value: function incrementProductQuantityInCart(product, cartItem) {
          return this.http.put(this.cartsUrl + "/" + cartItem.userId, cartItem).toPromise().then(function (res) {
            return res;
          })["catch"](this.handleError);
        }
      }, {
        key: "getAllCartItems",
        value: function getAllCartItems(loggedInUser) {
          return this.http.get(this.cartsUrl + "/" + loggedInUser.userId).toPromise().then(function (res) {
            return res;
          })["catch"](this.handleError);
        }
        ...
        value: function incrementOrDecrementQuantity(productWithCartUser, loggedInUser) {
          return this.http.put(this.cartsUrl + "/" + loggedInUser.userId, productWithCartUser).toPromise().then(function (res) {
            return res;
          })["catch"](this.handleError);
        }
      }, {
        key: "removeItemsFromCart",
        value: function removeItemsFromCart(loggedInUser) {
          return this.http.put(this.cartsUrl + "/delete/" + loggedInUser.userId, {}).toPromise().then(function (res) {
            return res;
          })["catch"](this.handleError);
        }
      }, {
        key: "updateOrderedItems",
        value: function updateOrderedItems(cart, loggedInUser) {
          return this.http.put(this.orderedUrl + "/update/" + loggedInUser.userId, cart).toPromise().then(function (res) {
            return res;
          })["catch"](this.handleError);
        }
      }, {
    ...
    var LoginService = /*#__PURE__*/function () {
      ...
      _createClass(LoginService, [{
        ...
        value: function getUser(userName) {
          ...
          return this.http.get(this.userUrl + "/" + userName).toPromise().then(function (res) {
            _this16.user = res;
            return res;
          })["catch"](this.handleError);
        }
        ...
        value: function addUser(user) {
          ...
          return this.http.post(this.userUrl, user).toPromise().then(function (res) {
            _this17.user = res;
            return res;
          })["catch"](this.handleError);
        }
  ...
  function srcAppServicesProductServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProductService = /*#__PURE__*/function () {
      ...
      _createClass(ProductService, [{
        key: "getProductsOnCategory",
        value: function getProductsOnCategory(category) {
          return this.http.get(this.productsCategoryUrl + "/" + category).toPromise().then(function (res) {
            return res;
          })["catch"](this.handleError);
        }
      }, {
        ...
        value: function getProduct(productId) {
          return this.http.get(this.productsUrl + "/" + productId).toPromise().then(function (res) {
            return res;
          })["catch"](this.handleError);
        }
  ...
  function srcMainTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_modules_app_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["platformBrowser"]().bootstrapModule(_app_modules_app_module__WEBPACK_IMPORTED_MODULE_2__["AppModule"])["catch"](function (err) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\radha\Desktop\Group_Project\cart-public\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
